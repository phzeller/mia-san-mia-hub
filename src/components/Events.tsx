...
const events = [
  {
    id: 1,
    title: "Champions League Finale im Besenwirt",
    description: "Das größte Spiel der Saison live im Besenwirt! Gemeinsam fiebern wir mit Bayern mit - bei bester Stimmung, Weißwurst und Weißbier.",
    date: "2024-06-01",
    time: "20:00",
    location: "Besenwirt Emertsham",
    type: "viewing",
    category: "upcoming",
    attendees: 85,
    maxAttendees: 100,
  ...
  {
    id: 3,
    title: "Oktoberfest im Besenwirt",
    description: "Bayerische Gemütlichkeit und Oktoberfest-Stimmung direkt im Besenwirt! Mit Schweinebraten, Weißbier und Bayern-Diskussionen.",
    date: "2024-09-22",
    time: "14:00",
    location: "Besenwirt Emertsham",
    type: "social",
  ...
  {
    id: 4,
    title: "Bundesliga Auftakt im Besenwirt",
    description: "Der Saisonstart 2024/25 im Besenwirt gefeiert! Tolle Stimmung und noch besseres Ergebnis - ein perfekter Abend!",
    date: "2024-08-18",
    time: "15:30",
    location: "Besenwirt Emertsham",
    type: "viewing",
  ...
  {
    id: 5,
    title: "Sommerfest mit Grillabend",
    description: "Unser jährliches Sommerfest mit Grillabend im Biergarten des Besenwirt. Perfekt für die ganze Familie - mit Testspielübertragung!",
    date: "2024-07-28",
    time: "12:00",
    location: "Biergarten Besenwirt",
    type: "social",
    category: "past",
    attendees: 180,
    maxAttendees: 200,
